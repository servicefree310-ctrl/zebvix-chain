...
const PHASES = [
  ...
  {
    id: "B32", title: "🔮 B.3.2 — Tendermint State Machine (NEXT)",
    color: "from-indigo-500 to-purple-600", lightColor: "text-indigo-400",
    borderColor: "border-indigo-500/40", bgColor: "bg-indigo-500/5",
    points: [
      { id: "b32_1", text: "Round-robin proposer selection (rotates by height/round)" },
      { id: "b32_2", text: "Propose / Prevote / Precommit / Commit timeouts (Tendermint state machine)" },
      { id: "b32_3", text: "2/3+ voting-power commit gate (replaces single-validator PoA producer)" },
      { id: "b32_4", text: "LastCommit field in block header (signed precommit set from prev block)" },
      { id: "b32_5", text: "Chain HALT if quorum missing — correct BFT behaviour (no liveness without majority)" },
      { id: "b32_6", text: "Optional B.3.1.5: hardcode founder pubkey in genesis to fix multi-node genesis divergence" },
      { id: "b32_7", text: "Optional: zbx_validators RPC method to remove CLI vs running-node DB lock conflict" },
    ],
  },
];
