...
const PHASES = [
  ...
  {
    id: "B322", title: "🔮 B.3.2.2 — State Machine Timeouts (NEXT)",
    color: "from-purple-500 to-fuchsia-600", lightColor: "text-purple-400",
    borderColor: "border-purple-500/40", bgColor: "bg-purple-500/5",
    points: [
      { id: "b322_1", text: "Propose → Prevote → Precommit → Commit phases (Tendermint state machine)" },
      { id: "b322_2", text: "Configurable timeouts per phase (default 1s/1s/1s/1s)" },
      { id: "b322_3", text: "Round increment if proposer absent → next validator takes over (liveness recovery)" },
      { id: "b322_4", text: "B.3.2.3: 2/3+ voting-power commit gate (block reject if quorum miss)" },
      { id: "b322_5", text: "B.3.2.4: LastCommit field in block header (signed precommit set from prev block)" },
    ],
  },
];
