...
const RUST_CHANGES: ChangeItem[] = [
  {
    ...
    details: [
      ...
      "MAX_STAKE_PER_VALIDATOR_ZBX = 5_000_000 (5M per slot max)",
...
const MOVE_MODULES: ChangeItem[] = [
  ...
  },
  {
    ...
    icon: Users,
    color: "text-blue-400",
    summary: "Validator staking + delegator system (120%/80%/40% APR)",
    details: [
      "MAX_VALIDATORS = 41, MIN_VALIDATOR_STAKE = 10,000 ZBX",
      "MAX_STAKE_PER_SLOT = 5,000,000 ZBX (self + all delegators)",
      "VALIDATOR_STAKING_APR_BPS = 12,000 (120%)",
      "DELEGATOR_APR_BPS = 8,000 (80%)",
      "VALIDATOR_DELEGATION_BONUS_BPS = 4,000 (40% bonus)",
      ...
      "fn stake() — become validator (41 slot cap, 10K min)",
      ...
      "fn delegate() — delegate to validator (slot cap enforced)",
      "fn undelegate() — reclaim delegated ZBX",
      "fn claim_delegation_rewards() — 80% APR on delegated amt",
      "fn set_founder_treasury() — pre-validator period routing",
      "fn fund_rewards() — protocol tops up reward_balance",
    ],
  },
  {
