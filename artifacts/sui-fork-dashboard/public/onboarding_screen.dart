            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient:
                      const LinearGradient(colors: [kZbxTeal, kZbxCyan]),
                ),
              ...
              OutlinedButton.icon(
                ...
                onPressed: busy ? null : () => _importMnemonic(context),
              ...
              OutlinedButton.icon(
                style: OutlinedButton.styleFrom(
                    minimumSize: const Size.fromHeight(52)),
                onPressed: busy ? null : () => _importPrivKey(context),
          ...
          OutlinedButton.icon(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                  content: Text(
                      'copied — paste only into your password manager')));
            },
