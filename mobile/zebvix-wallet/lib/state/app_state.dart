...
class AppState extends ChangeNotifier {
  ...
  Future<void> refresh() async {
    ...
    try {
      ...
      final stakedRes = await stakedF.catchError((_) => null);
      final lockedRes = await lockedF.catchError((_) => null);
      final nonceHex = await nonceF.catchError((_) => '0x0');
      final payRes = await payF.catchError((_) => null);
      ...
      String? payName;
      if (payRes is Map) payName = payRes['name']?.toString();
